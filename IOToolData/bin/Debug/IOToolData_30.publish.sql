...
GO
ALTER TABLE [dbo].[Requests] ALTER COLUMN [Weight] INT NOT NULL;
...
GO
PRINT N'Refreshing Procedure [dbo].[spRequests_GetByUser]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spRequests_GetByUser]';
