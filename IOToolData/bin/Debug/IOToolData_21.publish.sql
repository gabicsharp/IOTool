...
begin
	...
	select [Requests].[Id], [From].[Name], [To].[Name], [RequestStatus].[Status]
	from dbo.[Requests]
	join dbo.[RequestInfo] on [Requests].[Id] = [RequestInfo].[Id_Request]
	join dbo.[Suppliers] as [From] on [Requests].[Id_SupplierFrom] = [From].[Id]
	join dbo.[Suppliers] as [To] on [Requests].[Id_SupplierTo] = [To].[Id]
