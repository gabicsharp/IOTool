...
GO
PRINT N'Altering Procedure [dbo].[spRequests_StatusWork]...';


GO
ALTER PROCEDURE [dbo].[spRequests_StatusWork]
...
begin
	...
	select [Requests].[Id] as Id, [SupplierFrom].[Name] as [From], [SupplierTo].[Name] as [To], [RequestStatus].[Status] as [Status]
	from dbo.[Requests]
