!(function (t) {
        ...
        (a || f) &&
            (l = function (t) {
                var n,
                    ...
                    l = this;
                return (
                    f && (e = new RegExp("^" + l.source + "$(?!\\s)", i.call(l))),
                    a && (n = l.lastIndex),
                    (r = u.call(l, t)),
                    a && r && (l.lastIndex = l.global ? r.index + r[0].length : n),
                    f &&
                        r &&
                        r.length > 1 &&
    ...
    function (t, n, e) {
        ...
        })("versions", []).push({ version: r.version, mode: e(26) ? "pure" : "global", copyright: "© 2019 Denis Pushkarev (zloirock.ru)" });
    },
    function (t, n) {
        var e = 0,
            r = Math.random();
            ...
            if (!v || !d || ("replace" === t && !f) || ("split" === t && !s)) {
                var h = /./[p],
                    g = e(u, p, ""[t], function (t, n, e, r, o) {
                        return n.exec === l ? (v && !o ? { done: !0, value: h.call(n, e, r) } : { done: !0, value: t.call(e, n, r) }) : { done: !1 };
                    }),
                    x = g[0],
                    y = g[1];
    ...
    function (t, n, e) {
        ...
        (e(8).inspectSource = function (t) {
            ...
            (t.exports = function (t, n, e, c) {
                ...
                a && (i(e, "name") || o(e, "name", n)), t[n] !== e && (a && (i(e, u) || o(e, u, t[n] ? "" + t[n] : l.join(String(n)))), t === r ? (t[n] = e) : c ? (t[n] ? (t[n] = e) : o(t, n, e)) : (delete t[n], o(t, n, e)));
            ...
            return function (n, e) {
                ...
                return l < 0 || l >= a
                    ? t
                        ? ""
                        : void 0
                    : (i = c.charCodeAt(l)) < 55296 || i > 56319 || l + 1 === a || (u = c.charCodeAt(l + 1)) < 56320 || u > 57343
                    ? t
                        ? c.charAt(l)
                        : i
                    : t
    ...
    function (t, n, e) {
        "use strict";
        var r = e(9);
        e(29)({ target: "RegExp", proto: !0, forced: r !== /./.exec }, { exec: r });
    },
    function (t, n, e) {
        "use strict";
        var r = e(2);
    ...
    function (t, n, e) {
        var r = e(3),
            ...
            l = function (t, n, e) {
                ...
                for (a in (d && (e = n), e))
                    (s = ((f = !v && y && void 0 !== y[a]) ? y : e)[a]), (p = x && f ? c(s, r) : g && "function" == typeof s ? c(Function.call, s) : s), y && u(y, a, s, t & l.U), m[a] != s && i(m, a, p), g && b[a] != s && (b[a] = s);
            };
    ...
    function (t, n, e) {
        t.exports =
            ...
            !e(7)(function () {
                return (
                    7 !=
                    Object.defineProperty(e(32)("div"), "a", {
                        get: function () {
                            return 7;
                        },
                    }).a
                    ...
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (t, n) {
                              ...
                              for (
                                  ...
                                  (i = a.call(d, o)) && !((u = d.lastIndex) > s && (l.push(o.slice(s, i.index)), i.length > 1 && i.index < o.length && p.apply(l, i.slice(1)), (c = i[0].length), (s = u), l.length >= v));

                              )
                                  d.lastIndex === i.index && d.lastIndex++;
                              return s === o.length ? (!c && d.test("")) || l.push("") : l.push(o.slice(s)), l.length > v ? l.slice(0, v) : l;
                          }
                ...
                [
                    ...
                    function (t, n) {
                        ...
                        var a = o(t),
                            ...
                            h = i(a, RegExp),
                            g = a.unicode,
                            x = (a.ignoreCase ? "i" : "") + (a.multiline ? "m" : "") + (a.unicode ? "u" : "") + (v ? "y" : "g"),
                            y = new h(v ? a : "^(?:" + a.source + ")", x),
                        ...
                        for (var b = 0, S = 0, w = []; S < p.length; ) {
                            ...
                            var _,
                                E = l(y, v ? p : p.slice(S));
                            if (null === E || (_ = s(c(y.lastIndex + (v ? 0 : S)), p.length)) === b) S = u(p, S, g);
                            else {
